...
public interface GLCanvas {
	...
	// (Both end points are included).
	public abstract void drawRect(float x1, float y1, float x2, float y2,
			GLPaint paint);
	...
	public abstract void drawTexture(BasicTexture texture, int x, int y,
	...
	public abstract void drawTexture(BasicTexture texture, RectF source,
			RectF target);

	// Draw a texture with a specified texture transform.
	public abstract void drawTexture(BasicTexture texture,
			float[] mTextureTransform, int x, int y, int w, int h);

	// Draw two textures to the specified rectangle. The actual texture used is
	// from * (1 - ratio) + to * ratio
	// The two textures must have the same size.
	public abstract void drawMixed(BasicTexture from, int toColor, float ratio,
	 ...
	 */
	public abstract void initializeTextureSize(BasicTexture texture,
			int format, int type);
	 ...
	 *            The texture type (e.g. GL_UNSIGNED_BYTE)
	 */
	public abstract void texSubImage2D(BasicTexture texture, int xOffset,
	 ...
	 */
	public abstract void getBounds(Rect bounds, int x, int y, int width,
			int height);
}
