...
public class TextureUploader implements OnGLIdleListener {
	...
	private final ArrayDeque<UploadedTexture> mFgTextures = new ArrayDeque<UploadedTexture>(
			INIT_CAPACITY);
	private final ArrayDeque<UploadedTexture> mBgTextures = new ArrayDeque<UploadedTexture>(
			INIT_CAPACITY);
	...
	public boolean onGLIdle(GLCanvas canvas, boolean renderRequested) {
		...
		if (uploadQuota < QUOTA_PER_FRAME)
