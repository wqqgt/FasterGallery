...
import com.android.fastergallery.anim.CanvasAnimation;
import com.android.fastergallery.common.ApiHelper;
import com.android.fastergallery.common.Utils;
import com.android.fastergallery.glrenderer.BasicTexture;
import com.android.fastergallery.glrenderer.GLCanvas;
import com.android.fastergallery.glrenderer.GLES11Canvas;
import com.android.fastergallery.glrenderer.GLES20Canvas;
import com.android.fastergallery.glrenderer.UploadedTexture;
import com.android.fastergallery.util.GalleryUtils;
import com.android.fastergallery.util.MotionEventHelper;
import com.android.fastergallery.util.Profile;
...
public class GLRootView extends GLSurfaceView implements
	...
	private void onDrawFrameLocked(GL10 gl) {
		...
		if ((mOrientationSource != null && mDisplayRotation != mOrientationSource
				.getDisplayRotation()) || (mFlags & FLAG_NEED_LAYOUT) != 0) {
			layoutContentPane();
		}
	...
	public boolean dispatchTouchEvent(MotionEvent event) {
		...
		if (mCompensation != 0) {
			event = MotionEventHelper
					.transformEvent(event, mCompensationMatrix);
		}
