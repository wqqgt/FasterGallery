...
public class WakeLockHoldingProgressListener implements
	...
	public WakeLockHoldingProgressListener(
			AbstractGalleryActivity galleryActivity) {
		this(galleryActivity, DEFAULT_WAKE_LOCK_LABEL);
	}

	public WakeLockHoldingProgressListener(
			AbstractGalleryActivity galleryActivity, String label) {
		mActivity = galleryActivity;
		PowerManager pm = (PowerManager) ((Activity) mActivity)
