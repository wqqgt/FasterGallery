...
public class DetailsHelper {
	...
	public DetailsHelper(AbstractGalleryActivity activity, GLView rootPane,
	...
	public void layout(int left, int top, int right, int bottom) {
		if (mContainer instanceof GLView) {
			...
			view.measure(MeasureSpec.UNSPECIFIED, MeasureSpec.makeMeasureSpec(
					bottom - top, MeasureSpec.AT_MOST));
			view.layout(0, top, view.getMeasuredWidth(),
	...
	public static String resolveAddress(AbstractGalleryActivity activity,
			double[] latlng, AddressResolvingListener listener) {
	...
	public static void resolveResolution(String path,
			ResolutionResolvingListener listener) {
