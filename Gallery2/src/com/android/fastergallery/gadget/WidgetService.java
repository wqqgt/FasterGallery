...
public class WidgetService extends RemoteViewsService {
	...
	public RemoteViewsFactory onGetViewFactory(Intent intent) {
		...
		return new PhotoRVFactory((GalleryApp) getApplicationContext(), id,
				type, albumPath);
	}
	...
	private static class PhotoRVFactory implements
		...
		public RemoteViews getLoadingView() {
			RemoteViews rv = new RemoteViews(mApp.getAndroidContext()
					.getPackageName(), R.layout.appwidget_loading_item);
		...
		public RemoteViews getViewAt(int position) {
			...
			RemoteViews views = new RemoteViews(mApp.getAndroidContext()
					.getPackageName(), R.layout.appwidget_photo_item);
			views.setImageViewBitmap(R.id.appwidget_photo_item, bitmap);
			views.setOnClickFillInIntent(R.id.appwidget_photo_item,
