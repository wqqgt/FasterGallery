...
package com.android.fastergallery.picasasource;
...
import com.android.fastergallery.data.MediaSource;
import com.android.fastergallery.data.Path;
import com.android.fastergallery.data.PathMatcher;
...
public class PicasaSource extends MediaSource {
	...
	public static MediaItem getFaceItem(Context context, MediaItem item,
			int faceIndex) {
	...
	public static ParcelFileDescriptor openFile(Context context,
			MediaObject image, String mode) throws FileNotFoundException {
		throw new UnsupportedOperationException();
	}
