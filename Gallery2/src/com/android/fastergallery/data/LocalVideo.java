...
public class LocalVideo extends LocalMediaItem {
	...
	static final String[] PROJECTION = new String[] { VideoColumns._ID,
			VideoColumns.TITLE, VideoColumns.MIME_TYPE, VideoColumns.LATITUDE,
			VideoColumns.LONGITUDE, VideoColumns.DATE_TAKEN,
			VideoColumns.DATE_ADDED, VideoColumns.DATE_MODIFIED,
			VideoColumns.DATA, VideoColumns.DURATION, VideoColumns.BUCKET_ID,
			VideoColumns.SIZE, VideoColumns.RESOLUTION, };
	...
	public MediaDetails getDetails() {
		...
		if (s > 0) {
			details.addDetail(
					MediaDetails.INDEX_DURATION,
					GalleryUtils.formatDuration(
