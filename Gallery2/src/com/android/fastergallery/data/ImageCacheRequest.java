...
import com.android.fastergallery.data.BytesBufferPool.BytesBuffer;
...
abstract class ImageCacheRequest implements Job<Bitmap> {
	...
	public ImageCacheRequest(GalleryApp application, Path path, int type,
			int targetSize) {
	...
	public Bitmap run(JobContext jc) {
		...
		if (mType == MediaItem.TYPE_MICROTHUMBNAIL) {
			...
			bitmap = BitmapUtils.resizeDownBySideLength(bitmap, mTargetSize,
					true);
		}
		if (jc.isCancelled())
			return null;
