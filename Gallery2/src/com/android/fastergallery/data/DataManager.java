...
import com.android.fastergallery.app.StitchingChangeListener;
import com.android.fastergallery.common.Utils;
import com.android.fastergallery.data.MediaObject.PanoramaSupportCallback;
import com.android.fastergallery.data.MediaSet.ItemConsumer;
import com.android.fastergallery.data.MediaSource.PathId;
...
public class DataManager implements StitchingChangeListener {
	...
	public static final int INCLUDE_LOCAL_IMAGE_ONLY = INCLUDE_LOCAL_ONLY
			| INCLUDE_IMAGE;
	public static final int INCLUDE_LOCAL_VIDEO_ONLY = INCLUDE_LOCAL_ONLY
			| INCLUDE_VIDEO;
	public static final int INCLUDE_LOCAL_ALL_ONLY = INCLUDE_LOCAL_ONLY
			| INCLUDE_IMAGE | INCLUDE_VIDEO;
	...
	public void registerChangeNotifier(Uri uri, ChangeNotifier notifier) {
		...
		synchronized (mNotifierMap) {
			...
			if (broker == null) {
				...
				mApplication.getContentResolver().registerContentObserver(uri,
						true, broker);
