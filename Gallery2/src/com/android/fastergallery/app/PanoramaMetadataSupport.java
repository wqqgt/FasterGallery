...
import com.android.fastergallery.data.PanoramaMetadataJob;
...
import com.android.fastergallery.util.LightCycleHelper.PanoramaMetadata;
 ...
 * support panoramas.
 */
public class PanoramaMetadataSupport implements
		FutureListener<PanoramaMetadata> {
	...
	public void getPanoramaSupport(GalleryApp app,
			PanoramaSupportCallback callback) {
		synchronized (mLock) {
			if (mPanoramaMetadata != null) {
				callback.panoramaInfoAvailable(mMediaObject,
