...
public class PhotoPageBottomControls implements OnClickListener {
	...
	public PhotoPageBottomControls(Delegate delegate, Context context,
		...
		mContainer = (ViewGroup) inflater.inflate(
				R.layout.photopage_bottom_controls, mParentLayout, false);
	...
	public void refresh() {
		...
		for (View control : mControlsVisible.keySet()) {
			...
			if (prevVisibility.booleanValue() != curVisibility) {
				...
				control.setVisibility(curVisibility ? View.VISIBLE
						: View.INVISIBLE);
