...
import com.android.fastergallery.util.LightCycleHelper.PanoramaViewHelper;
...
public class AbstractGalleryActivity extends Activity implements GalleryContext {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		mGLRootView.lockRenderThread();
		try {
			getStateManager().notifyActivityResult(requestCode, resultCode,
					data);
		} finally {
			mGLRootView.unlockRenderThread();
		}
	...
	private void doBindBatchService() {
		bindService(new Intent(this, BatchService.class),
				mBatchServiceConnection, Context.BIND_AUTO_CREATE);
