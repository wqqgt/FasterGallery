...
import com.android.fasterphotos.data.PhotoProvider.Accounts;
import com.android.fasterphotos.data.PhotoProvider.Albums;
import com.android.fasterphotos.data.PhotoProvider.Metadata;
import com.android.fasterphotos.data.PhotoProvider.Photos;
...
public class PhotoDatabase extends SQLiteOpenHelper {
	...
	private static final String[][] CREATE_PHOTO = {
			...
			{ Photos.MIME_TYPE, "TEXT NOT NULL" }, { Photos.TITLE, "TEXT" },
	...
	private static final String[][] CREATE_ALBUM = {
			...
			{ Albums.PARENT_ID, "INTEGER" }, { Albums.ALBUM_TYPE, "TEXT" },
			{ Albums.VISIBILITY, "INTEGER NOT NULL" },
			{ Albums.LOCATION_STRING, "TEXT" },
			{ Albums.TITLE, "TEXT NOT NULL" }, { Albums.SUMMARY, "TEXT" },
	...
	protected static String[] createUniqueConstraint(String column1,
			String column2) {
	...
	protected static void addToTable(List<String[]> createTable,
			String[][] columns, String[][] constraints) {
		if (columns != null) {
			for (String[] column : columns) {
