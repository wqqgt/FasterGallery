...
public class HelpUtils {
	...
	public static Intent getHelpIntent(Context context, int helpUrlResId) {
		...
		if (TextUtils.isEmpty(helpUrlString)) {
			...
			// parameters.
			final Uri fullUri = uriWithAddedParameters(context,
					Uri.parse(helpUrlString));
	 ...
	 * version code of the app's package as gotten via the context.
	 * 
	...
	private static Uri uriWithAddedParameters(Context context, Uri baseUri) {
		...
		builder.appendQueryParameter(PARAM_LANGUAGE_CODE, Locale.getDefault()
				.toString());
