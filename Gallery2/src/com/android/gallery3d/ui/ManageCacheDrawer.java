...
public class ManageCacheDrawer extends AlbumSetSlotRenderer {
	...
	public ManageCacheDrawer(AbstractGalleryActivity activity,
		...
		mCheckedItem = new ResourceTexture(context,
				R.drawable.btn_make_offline_normal_on_holo_dark);
		mUnCheckedItem = new ResourceTexture(context,
				R.drawable.btn_make_offline_normal_off_holo_dark);
		mLocalAlbumIcon = new ResourceTexture(context,
				R.drawable.btn_make_offline_disabled_on_holo_dark);
	...
	public int renderSlot(GLCanvas canvas, int index, int pass, int width,
		...
		drawCachingPin(canvas, entry.setPath, entry.sourceType, isCaching,
				chooseToCache, width, height);
