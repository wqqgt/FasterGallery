...
public class ImageCurves extends ImageShow {
	...
	private ImageFilterCurves curves() {
		...
		if (p != null) {
			return (ImageFilterCurves) FiltersManager.getManager().getFilter(
					ImageFilterCurves.class);
		}
		return null;
	}
	...
	public void onDraw(Canvas canvas) {
		...
		getSpline(mCurrentCurveIndex).draw(canvas,
				Spline.colorForCurve(mCurrentCurveIndex), getWidth(),
				getHeight(), true, mDoingTouchMove);
		drawToast(canvas);
