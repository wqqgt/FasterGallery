...
public class Spline {
	...
	private void drawHandles(Canvas canvas, Drawable indicator, float centerX,
			float centerY) {
		int left = (int) centerX - mCurveHandleSize / 2;
		int top = (int) centerY - mCurveHandleSize / 2;
		indicator.setBounds(left, top, left + mCurveHandleSize, top
				+ mCurveHandleSize);
	...
	public void draw(Canvas canvas, int color, int canvasWidth,
			int canvasHeight, boolean showHandles, boolean moving) {
