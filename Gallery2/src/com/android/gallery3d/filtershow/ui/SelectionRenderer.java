...
public class SelectionRenderer {
	...
	public static void drawSelection(Canvas canvas, int left, int top,
			int right, int bottom, int stroke, Paint paint) {
	...
	public static void drawSelection(Canvas canvas, int left, int top,
			int right, int bottom, int stroke, Paint selectPaint, int border,
			Paint borderPaint) {
		...
		canvas.drawRect(left + stroke, top + stroke, right - stroke, top
				+ stroke + border, borderPaint);
		canvas.drawRect(left + stroke, bottom - stroke - border,
				right - stroke, bottom - stroke, borderPaint);
