...
public class FramedTextButton extends ImageButton {
	...
	public void onDraw(Canvas canvas) {
		...
		int w = getWidth();
		int h = getHeight();
		canvas.drawRect(mTextPadding, mTextPadding, w - mTextPadding, h
				- mTextPadding, gPaint);
		gPath.reset();
		gPath.moveTo(w - mTextPadding - mTrianglePadding - mTriangleSize, h
				- mTextPadding - mTrianglePadding);
		gPath.lineTo(w - mTextPadding - mTrianglePadding, h - mTextPadding
				- mTrianglePadding - mTriangleSize);
		gPath.lineTo(w - mTextPadding - mTrianglePadding, h - mTextPadding
				- mTrianglePadding);
		gPath.close();
