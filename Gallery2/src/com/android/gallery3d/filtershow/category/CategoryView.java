...
public class CategoryView extends View implements View.OnClickListener {
	...
	public CategoryView(Context context) {
		...
		mBackgroundColor = res
				.getColor(R.color.filtershow_categoryview_background);
	...
	public void onDraw(Canvas canvas) {
		...
		if (mAction != null) {
			...
			if (mAction.getImage() == null) {
				mAction.setImageFrame(new Rect(0, 0, canvas.getWidth(), canvas
						.getHeight()));
			} else {
				...
				if (mAdapter.isSelected(this)) {
					SelectionRenderer.drawSelection(canvas, 0, 0,
							...
							mSelectionStroke, mSelectPaint, mBorderStroke,
							mBorderPaint);
				}
			}
