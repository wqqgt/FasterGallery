...
public class MainPanel extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		geometryButton = (ImageButton) mMainView
				.findViewById(R.id.geometryButton);
	...
	private void setCategoryFragment(CategoryPanel category, boolean fromRight) {
		...
		transaction.replace(R.id.category_panel_container, category,
				CategoryPanel.FRAGMENT_TAG);
		transaction.commit();
	}
	...
	public void showImageStatePanel(boolean show) {
		...
		FragmentTransaction transaction = getChildFragmentManager()
				.beginTransaction();
		final View container = mMainView
				.findViewById(R.id.state_panel_container);
		if (show) {
