...
public class RenderingRequest {
	...
	public static void post(Bitmap source, ImagePreset preset, int type,
		...
		if (((type != PARTIAL_RENDERING && type != HIGHRES_RENDERING) && source == null)
			...
			Log.v(LOGTAG, "something null: source: " + source + " or preset: "
		...
		if (type == FULL_RENDERING || type == GEOMETRY_RENDERING
				|| type == ICON_RENDERING || type == STYLE_ICON_RENDERING) {
			...
			bitmap = Bitmap.createBitmap(source.getWidth(), source.getHeight(),
					mConfig);
		}
