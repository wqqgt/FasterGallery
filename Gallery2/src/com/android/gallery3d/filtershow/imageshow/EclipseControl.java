...
public class EclipseControl {
	...
	public void paintGrayPoint(Canvas canvas, float x, float y) {
		...
		int[] colors3 = new int[] { Color.GRAY, Color.LTGRAY, 0x66000000, 0 };
		RadialGradient g = new RadialGradient(x, y, mCenterDotSize, colors3,
	...
	public void paintOvallines(Canvas canvas, RectF rect, Paint paint,
	...
	public void fillHandles(Canvas canvas, float cx, float cy, float rx,
			float ry) {
		handlex[0] = cx;
		handley[0] = cy;
		int k = 1;
