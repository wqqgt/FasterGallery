...
public class FilterEnvironment {
	...
	private HashMap<Long, WeakReference<Bitmap>> bitmapCach = new HashMap<Long, WeakReference<Bitmap>>();
	...
	public void applyRepresentation(FilterRepresentation representation,
		...
		ImageFilter filter = mFiltersManager
	...
	public Bitmap applyRepresentation(FilterRepresentation representation,
			Bitmap bitmap) {
		ImageFilter filter = mFiltersManager
				.getFilterForRepresentation(representation);
		filter.useRepresentation(representation);
