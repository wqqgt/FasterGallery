...
public class StateView extends View {
	...
	public StateView(Context context, int type) {
		...
		mEndsBackgroundColor = res
				.getColor(R.color.filtershow_stateview_end_background);
		mEndsTextColor = res.getColor(R.color.filtershow_stateview_end_text);
		mBackgroundColor = res
				.getColor(R.color.filtershow_stateview_background);
		mTextColor = res.getColor(R.color.filtershow_stateview_text);
		mSelectedBackgroundColor = res
				.getColor(R.color.filtershow_stateview_selected_background);
		mSelectedTextColor = res
				.getColor(R.color.filtershow_stateview_selected_text);
	...
	public void drawText(Canvas canvas) {
		...
		int y = mTextBounds.height()
				+ (canvas.getHeight() - mTextBounds.height()) / 2;
