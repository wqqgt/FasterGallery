...
public class EditorPanel extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mMainView = (LinearLayout) inflater.inflate(
				R.layout.filtershow_editor_panel, null);

		View actionControl = mMainView
				.findViewById(R.id.panelAccessoryViewList);
		View editControl = mMainView.findViewById(R.id.controlArea);
		ImageButton cancelButton = (ImageButton) mMainView
				.findViewById(R.id.cancelFilter);
		ImageButton applyButton = (ImageButton) mMainView
		...
		if (mEditor != null) {
			mEditor.setUpEditorUI(actionControl, editControl, editTitle,
					toggleState);
	...
	public void showImageStatePanel(boolean show) {
		...
		FragmentTransaction transaction = getChildFragmentManager()
				.beginTransaction();
		Fragment panel = getActivity().getSupportFragmentManager()
		...
		if (show) {
			...
			transaction.replace(R.id.state_panel_container, statePanel,
