...
public class ImageFilterCurves extends ImageFilter {
	...
	public Bitmap apply(Bitmap bitmap, float scaleFactor, int quality) {
		if (!mParameters.getSpline(Spline.RGB).isOriginal()) {
			...
			nativeApplyGradientFilter(bitmap, bitmap.getWidth(),
					bitmap.getHeight(), rgbGradient, rgbGradient, rgbGradient);
		}
		...
		nativeApplyGradientFilter(bitmap, bitmap.getWidth(),
				bitmap.getHeight(), redGradient, greenGradient, blueGradient);
		return bitmap;
	}
