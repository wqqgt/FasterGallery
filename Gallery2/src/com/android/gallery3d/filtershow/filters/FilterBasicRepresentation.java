...
public class FilterBasicRepresentation extends FilterRepresentation implements
		ParameterInteger {
	...
	public FilterBasicRepresentation(String name, int minimum, int value,
			int maximum) {
		super(name);
		mMinimum = minimum;
		mMaximum = maximum;
	...
	public boolean equals(FilterRepresentation representation) {
		...
		if (representation instanceof FilterBasicRepresentation) {
			...
			if (basic.mMinimum == mMinimum && basic.mMaximum == mMaximum
					&& basic.mValue == mValue
