...
public class FilterFxRepresentation extends FilterRepresentation {
	...
	public FilterFxRepresentation(String name, int bitmapResource,
			int nameResource) {
		super(name);
	...
	public String toString() {
		return "FilterFx: " + hashCode() + " : " + getName() + " bitmap rsc: "
				+ mBitmapResource;
	}

	@Override
	public synchronized FilterRepresentation clone()
			throws CloneNotSupportedException {
		FilterFxRepresentation representation = (FilterFxRepresentation) super
				.clone();
