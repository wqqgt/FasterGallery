...
public class FilterRepresentation implements Cloneable {
	...
	public FilterRepresentation clone() throws CloneNotSupportedException {
		FilterRepresentation representation = (FilterRepresentation) super
				.clone();
		...
		representation.mTempRepresentation = mTempRepresentation != null ? mTempRepresentation
				.clone() : null;
		if (DEBUG) {
	...
	public synchronized void updateTempParametersFrom(
