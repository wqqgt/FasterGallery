...
public class ColorValueView extends View implements ColorListener {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		setupButton();
		invalidate((int) (ox - dotRadus), (int) (oy - dotRadus),
				(int) (ox + dotRadus), (int) (oy + dotRadus));
		invalidate((int) (mDotX - dotRadus), (int) (mDotY - dotRadus),
				(int) (mDotX + dotRadus), (int) (mDotY + dotRadus));
	...
	private void setupButton() {
		...
		RadialGradient g = new RadialGradient(mDotX, mDotY, dotRadus, colors3,
	...
	private void updatePaint() {
		...
		Shader sg = new LinearGradient(mBorder, mBorder, mBorder, mHeight
