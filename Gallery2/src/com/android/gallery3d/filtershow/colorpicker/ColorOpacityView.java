...
public class ColorOpacityView extends View implements ColorListener {
	...
	public ColorOpacityView(Context ctx, AttributeSet attrs) {
		...
		mDotPaint.setColor(ctx.getResources()
				.getColor(R.color.slider_dot_color));
		...
		Bitmap bitmap = Bitmap.createBitmap(colors, 16, 16,
				Bitmap.Config.ARGB_8888);
		BitmapShader bs = new BitmapShader(bitmap, Shader.TileMode.REPEAT,
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		setupButton();
		invalidate((int) (ox - mDotRadius), (int) (oy - mDotRadius),
				(int) (ox + mDotRadius), (int) (oy + mDotRadius));
		invalidate((int) (mDotX - mDotRadius), (int) (mDotY - mDotRadius),
				(int) (mDotX + mDotRadius), (int) (mDotY + mDotRadius));
	...
	private void setupButton() {
		...
		RadialGradient g = new RadialGradient(mDotX, mDotY, mDotRadius,
				colors3, new float[] { 0, .3f, .31f, 1 }, Shader.TileMode.CLAMP);
	...
	private void updatePaint() {
		...
		Shader sg = new LinearGradient(mBorder, mBorder, mWidth - mBorder,
				mBorder, color1, color2, Shader.TileMode.CLAMP);
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawRect(mBorder, mBorder, mWidth - mBorder, mHeight - mBorder,
				mCheckPaint);
		canvas.drawRect(mBorder, mBorder, mWidth - mBorder, mHeight - mBorder,
				mBarPaint1);
