...
public class CameraControls extends RotatableLayout {
	...
	public void onAttachedToWindow() {
		...
		if (ApiHelper.HAS_DISPLAY_LISTENER) {
			((DisplayManager) getContext().getSystemService(
					Context.DISPLAY_SERVICE)).registerDisplayListener(
					(DisplayListener) mDisplayListener, null);
		}
	}
	...
	public void onWindowVisibilityChanged(int visibility) {
		if (visibility == View.VISIBLE) {
			// Make sure when coming back from onPause, the layout is rotated
			// correctly
			checkLayoutFlip();
		}
	}
	...
	// In reverse landscape and reverse portrait, camera controls will be laid
	// out
	// on the wrong side of the screen. We need to make adjustment to move the
	// controls
	// to the USB side
