...
public class Switch extends CompoundButton {
	...
	public Switch(Context context, AttributeSet attrs, int defStyle) {
		...
		mThumbTextPadding = res
				.getDimensionPixelSize(R.dimen.thumb_text_padding);
		mSwitchMinWidth = res.getDimensionPixelSize(R.dimen.switch_min_width);
		mSwitchTextMaxWidth = res
				.getDimensionPixelSize(R.dimen.switch_text_max_width);
	...
	public void onPopulateAccessibilityEvent(AccessibilityEvent event) {
		...
		CharSequence text = isChecked() ? mOnLayout.getText() : mOffLayout
				.getText();
	...
	private Layout makeLayout(CharSequence text, int maxWidth) {
		int actual_width = (int) Math.ceil(Layout.getDesiredWidth(text,
				mTextPaint));
		StaticLayout l = new StaticLayout(text, 0, text.length(), mTextPaint,
				actual_width, Layout.Alignment.ALIGN_NORMAL, 1.f, 0, true,
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.translate(
				(thumbLeft + thumbRight) / 2 - switchText.getEllipsizedWidth()
						/ 2, (switchInnerTop + switchInnerBottom) / 2
