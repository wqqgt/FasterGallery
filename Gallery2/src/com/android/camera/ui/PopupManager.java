...
/**
 * A manager which notifies the event of a new popup in order to dismiss the old
 * popup if exists.
 */
public class PopupManager {
	private static HashMap<Context, PopupManager> sMap = new HashMap<Context, PopupManager>();
	...
	public void setOnOtherPopupShowedListener(
			OnOtherPopupShowedListener listener) {
