...
public class ZoomRenderer extends OverlayRenderer implements
	...
	public ZoomRenderer(Context ctx) {
		...
		mTextPaint.setTextSize(res
				.getDimensionPixelSize(R.dimen.zoom_font_size));
	...
	public void onDraw(Canvas canvas) {
		...
		canvas.drawLine(mCenterX - mMinCircle, mCenterY, mCenterX - mMaxCircle
				- 4, mCenterY, mPaint);
		...
		canvas.drawText(txt, mCenterX - mTextBounds.centerX(), mCenterY
	...
	public boolean onScale(ScaleGestureDetector detector) {
		...
		if (mListener != null && (int) circle != mCircleSize) {
			...
			int zoom = mMinZoom
					+ (int) ((mCircleSize - mMinCircle) * (mMaxZoom - mMinZoom) / (mMaxCircle - mMinCircle));
