...
public class RotatableLayout extends FrameLayout {
	...
	// Initial orientation of the layout (ORIENTATION_PORTRAIT, or
	...
	protected void rotateChildren(boolean clockwise) {
		...
		if (mListener != null)
			mListener.onRotation(clockwise ? 90 : 270);
	}
	...
	public static boolean isClockWiseRotation(int prevRotation,
			int currentRotation) {
