...
public class ComboPreferences implements SharedPreferences,
	...
	private static String getLocalSharedPreferencesName(Context context,
			int cameraId) {
	...
	private void movePrefFrom(Map<String, ?> m, String key,
	...
	private void moveGlobalPrefsFrom(SharedPreferences src) {
		...
		movePrefFrom(prefMap,
				CameraSettings.KEY_VIDEO_TIME_LAPSE_FRAME_INTERVAL, src);
		movePrefFrom(prefMap, CameraSettings.KEY_CAMERA_ID, src);
		movePrefFrom(prefMap, CameraSettings.KEY_RECORD_LOCATION, src);
		movePrefFrom(prefMap, CameraSettings.KEY_CAMERA_FIRST_USE_HINT_SHOWN,
				src);
		movePrefFrom(prefMap, CameraSettings.KEY_VIDEO_FIRST_USE_HINT_SHOWN,
				src);
