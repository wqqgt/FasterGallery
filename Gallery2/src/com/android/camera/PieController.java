...
public class PieController {
	...
	protected PieItem makeItem(CharSequence value) {
		TextDrawable drawable = new TextDrawable(mActivity.getResources(),
				value);
	...
	public PieItem makeDialItem(ListPreference pref, int iconId, float center,
			float sweep) {
