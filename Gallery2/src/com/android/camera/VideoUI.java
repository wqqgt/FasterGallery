...
public class VideoUI implements SurfaceHolder.Callback,
		PieRenderer.PieListener, PreviewGestures.SingleTapListener,
	...
	private void initializeMiscControls() {
		mPreviewFrameLayout = (PreviewFrameLayout) mRootView
		...
		mRecordingTimeView = (TextView) mRootView
				.findViewById(R.id.recording_time);
		mRecordingTimeRect = (RotateLayout) mRootView
				.findViewById(R.id.recording_time_rect);
		mTimeLapseLabel = mRootView.findViewById(R.id.time_lapse_label);
		// The R.id.labels can only be found in phone layout.
		// That is, mLabelsLinearLayout should be null in tablet layout.
		mLabelsLinearLayout = (LinearLayout) mRootView
	...
	public void showRecordingUI(boolean recording, boolean zoomSupported) {
		...
		if (recording) {
			mShutterButton
					.setImageResource(R.drawable.btn_shutter_video_recording);
			mActivity.hideSwitcher();
