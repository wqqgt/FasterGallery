...
public class FocusOverlayManager {
	...
	public FocusOverlayManager(ComboPreferences preferences,
			String[] defaultFocusModes, Parameters parameters,
	...
	public void setParameters(Parameters parameters) {
		...
		mLockAeAwbNeeded = (Util.isAutoExposureLockSupported(mParameters) || Util
	...
	public String getFocusMode() {
		...
		if (mFocusAreaSupported && !mFocusDefault) {
			...
			mFocusMode = mPreferences.getString(CameraSettings.KEY_FOCUS_MODE,
					null);
