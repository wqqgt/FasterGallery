...
public class IconListPreference extends ListPreference {
	...
	public IconListPreference(Context context, AttributeSet attrs) {
		...
		mIconIds = getIds(res,
				a.getResourceId(R.styleable.IconListPreference_icons, 0));
		mLargeIconIds = getIds(res,
				a.getResourceId(R.styleable.IconListPreference_largeIcons, 0));
		mImageIds = getIds(res,
				a.getResourceId(R.styleable.IconListPreference_images, 0));
		a.recycle();
	}
	...
	public void filterUnsupported(List<String> supported) {
		...
		if (mImageIds != null)
			mImageIds = imageIds.toArray(new int[imageIds.size()]);
