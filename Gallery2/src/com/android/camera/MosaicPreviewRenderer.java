...
public class MosaicPreviewRenderer {
	...
	private class EGLHandler extends Handler {
		...
		private void doAlignFrame() {
			...
			// Call preprocess to render it to low-res and high-res RGB
			// textures.
		...
		private void doInitGL() {
			...
			mEglSurface = mEgl.eglCreateWindowSurface(mEglDisplay, mEglConfig,
					mMosaicOutputSurfaceTexture, null);
	...
	public MosaicPreviewRenderer(SurfaceTexture tex, int w, int h,
			boolean isLandscape) {
		...
		// We need to sync this because the generation of surface texture for
		// input is
	...
	private static final int[] CONFIG_SPEC = new int[] {
			EGL10.EGL_RENDERABLE_TYPE, EGL_OPENGL_ES2_BIT, EGL10.EGL_RED_SIZE,
			8, EGL10.EGL_GREEN_SIZE, 8, EGL10.EGL_BLUE_SIZE, 8, EGL10.EGL_NONE };
	...
	private static EGLConfig chooseConfig(EGL10 egl, EGLDisplay display) {
		...
		if (!egl.eglChooseConfig(display, CONFIG_SPEC, configs, numConfigs,
				numConfig)) {
