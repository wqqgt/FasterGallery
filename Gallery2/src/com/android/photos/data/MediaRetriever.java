...
public interface MediaRetriever {
	public enum MediaSize {
		TemporaryThumbnail(5), Thumbnail(10), TemporaryPreview(15), Preview(20), Original(
				30);
	 ...
	 * 
	 * @param contentUri
	 *            The original media Uri.
	 * @param size
	 *            The target size to search for a fast-access image.
	 ...
	 *            The original media Uri.
	 * @param temporarySize
	 *            The target media size. Guaranteed to be a MediaSize for which
	 ...
	 * @param size
	 *            The size of the image being requested
	 ...
	 * 
	 * @param contentUri
	 *            The URI for the size being normalized.
	 * @param size
