...
public abstract class SQLiteContentProvider extends ContentProvider {
	 ...
	 * transaction.
	 */
	public abstract int updateInTransaction(Uri uri, ContentValues values,
	 ...
	 * transaction.
	 */
	public abstract int deleteInTransaction(Uri uri, String selection,
		...
		try {
			...
			for (int i = 0; i < numOperations; i++) {
				...
				if (!callerIsSyncAdapter
						&& isCallerSyncAdapter(operation.getUri())) {
