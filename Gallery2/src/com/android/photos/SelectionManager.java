		...
		if (ApiHelper.AT_LEAST_16) {
			...
			mNfcAdapter.setBeamPushUrisCallback(new CreateBeamUrisCallback() {
				...
				public Uri[] createBeamUris(NfcEvent arg0) {
					// This will have been preceded by a call to
					// onItemSelectedStateChange
					if (mCachedShareableUris == null)
						return null;
					return mCachedShareableUris
							.toArray(new Uri[mCachedShareableUris.size()]);
				}
			}, mActivity);
		}
	}
