...
/**
 * Returns all MediaSets in a MediaSet, wrapping them in a cursor to appear like
 * a AlbumSetLoader.
 */
public class MediaSetLoader extends AsyncTaskLoader<Cursor> implements
	...
	public Cursor loadInBackground() {
		...
		for (int i = 0; i < count; i++) {
			...
			row[AlbumSetLoader.INDEX_SUPPORTED_OPERATIONS] = m
