 ...
 */
public class MediaItemsLoader extends AsyncTaskLoader<Cursor> implements
	...
	public Cursor loadInBackground() {
		...
		mMediaSet.enumerateTotalMediaItems(new ItemConsumer() {
			...
			public void consume(int index, MediaItem item) {
				...
				row[PhotoSetLoader.INDEX_DATA] = item.getContentUri()
						.toString();
				...
				row[PhotoSetLoader.INDEX_SUPPORTED_OPERATIONS] = item
