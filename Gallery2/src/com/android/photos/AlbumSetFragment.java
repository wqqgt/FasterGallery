...
public class AlbumSetFragment extends MultiSelectGridFragment implements
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		getGridView().setColumnWidth(
				getActivity().getResources().getDimensionPixelSize(
						R.dimen.album_set_item_width));
	}
	...
	public void onGridItemClick(GridView g, View v, int position, long id) {
		...
		intent.putExtra(AlbumActivity.KEY_ALBUM_URI, mLoaderCompatShim
				.getPathForItem(item).toString());
	...
	public int getItemSupportedOperations(Object item) {
		return ((Cursor) item)
				.getInt(AlbumSetLoader.INDEX_SUPPORTED_OPERATIONS);
	}
