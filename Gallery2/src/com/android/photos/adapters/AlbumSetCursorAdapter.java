...
public class AlbumSetCursorAdapter extends CursorAdapter {
	...
	public void bindView(View v, Context context, Cursor cursor) {
		TextView titleTextView = (TextView) v
				.findViewById(R.id.album_set_item_title);
		titleTextView.setText(cursor.getString(AlbumSetLoader.INDEX_TITLE));

		TextView countTextView = (TextView) v
				.findViewById(R.id.album_set_item_count);
		...
		ImageView thumbImageView = (ImageView) v
				.findViewById(R.id.album_set_item_image);
	...
	public View newView(Context context, Cursor cursor, ViewGroup parent) {
		return LayoutInflater.from(context).inflate(R.layout.album_set_item,
				parent, false);
	}
}
